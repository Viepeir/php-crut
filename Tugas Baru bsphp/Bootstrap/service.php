...
<body>
    <div class="row g-0">
        <div class="col-md-2 d-flex flex-column flex-shrink-0 p-3 text-white bg-primary" style="min-height: 100vh;">
            ...
            <ul class="nav nav-pills flex-column mb-auto" st>
                ...
                <li class="nav-item">
                    <a href="Projects.html" class="nav-link text-white fs-5" ><i class="bi bi-journal"></i> Project</a>
                </li>
                <li class="nav-item">
